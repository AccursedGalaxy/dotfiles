    ...
    Variants {
        ...
        PanelWindow {
            ...
            onWallpaperPathChanged: {
                // Completely disable wallpaper processing to avoid conflicts with swww
                // bgRoot.updateZoomScale()
                // Clock position stays fixed - updateClockPosition() not called
            }
            ...
            Process {
                ...
                stdout: StdioCollector {
                    ...
                    onStreamFinished: {
                        ...
                        // Clock position stays fixed - don't call updateClockPosition()
                        // This keeps clock in same position for all wallpapers
                    }
                }
            }
            ...
            // Wallpaper (disabled - using swww instead)
            Image {
                id: wallpaper
                visible: false // Disabled to prevent conflict with swww
